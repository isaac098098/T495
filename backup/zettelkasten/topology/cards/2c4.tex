...
({\scshape\romannumeral 2}) Corolario de \hyperref[card:2c3]{\textsf{2c3}}. ({\scshape\romannumeral 3}) Se sigue de ({\scshape\romannumeral 1}) y ({\scshape\romannumeral 2}). ({\scshape\romannumeral 4}) Se sigue de \hyperref[card:2c2]{\textsf{2c2}} ({\scshape\romannumeral 3}) y del punto anterior. ({\scshape\romannumeral 5}). Se sigue del punto anterior. ({\scshape\romannumeral 6}) Es fácil ver que $i_{\lambda} : X_{\lambda} \longrightarrow X_{\lambda} \times \{ \lambda \}$ es biyectiva. Es además continua y abierta, luego un homeomorfismo.
