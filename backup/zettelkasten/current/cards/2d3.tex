\zheader{Propiedades de las identificaciones}{propiedades, composición, identificación}{2d3}
...
\begin{proof}
({\romannumeral 1}) Se sigue de que $U$ es abierto en $X$ si y sólo si $\text{id}_X(U) = U$ es abierto en $X$.
\bigskip

({\romannumeral 2}) Como $f$ y $g$ son identificaciones, entonces, por \hyperref[card:2d2]{\textsf{2d2}},
\begin{align*}
