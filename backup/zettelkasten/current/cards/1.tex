\zheader{Propiedades de conjuntos y funciones}{propiedades, imagen, imagen inversa}{1}
...
\begin{multicols}{2}
    \begin{enumerate}[label=\textnormal{(\roman*)}, align=left, labelwidth=2.0em, leftmargin=2.3em]
