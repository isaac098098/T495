\zheader{Propiedades de saturación}{definición, saturación, identificación}{2c10a}
...
\begin{proof}
({\romannumeral 1}) Como $A$ es saturado, entonces $A = p^{-1}(p(A))$ y dado que $p$ es identificación y $A$ es abierto, $p(A)$ debe ser abierto en $X/\sim$. Y nuevamente, como $A = p^{-1}(p(A))$, entonces $p|_A : A \longrightarrow p(A)$ es una identificación por \hyperref[card:2c8]{\textsf{2c8}}.
\bigskip
