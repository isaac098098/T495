...
\fancypagestyle{title-subsection}{
	...
	\fancyhead[LO]{\hspace{0.8cm}\small\scshape\nouppercase Introduction to Complex Variables} %left odd
...
%\addto{\captionsspanish}{\renewcommand{\bibname}{Recommended Lectures}} %babel, biblatex, changes bib section title
\addto{\captionsspanish}{\renewcommand{\refname}{Recommended Lectures}} %babel, bibtex, changes bib section title

%Metadata, depends on hyperref
\title{\LARGE\scshape\notestitle\vspace{-1.0em}}
\date{\today}
\author{\normalsize\notesprof \\ \normalsize\notesauthor}
\date{}
